...
function yelpButton(label = 'Find us on Yelp') { return `<a class="button yelp-button" href="${YELP_URL}" target="_blank" rel="noopener noreferrer">${yelpMark()}<span>${label}</span>${icon('arrow')}</a>` }
