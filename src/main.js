...
const services = [
  ...
  { id: 'move', number: '03', title: 'Move-in / move-out cleaning', short: 'A clean handoff for the next chapter.', text: 'Move-in / move-out cleaning for a property ready to welcome someone new or leave in its best possible condition.', tags: ['Rental ready', 'Thorough'], before: '/assets/before-after/move-in-out-antes.webp', after: '/assets/before-after/move-in-out-despues.webp' },
...
function menuResultsGallery() { return `<div class="menu-results-gallery"><div class="section-kicker">11 / Additional finished results</div><p>More spaces renewed with the same detail-led care.</p><div class="menu-results-grid">${resultsGallery.map(([file, alt]) => `<figure><img src="/assets/results/${file}" alt="${alt}" loading="lazy" /><figcaption>${alt}</figcaption></figure>`).join('')}</div></div>` }
