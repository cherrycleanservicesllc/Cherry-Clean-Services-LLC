...
function header() {
  return `<header class="site-header"><a class="brand" href="/" data-link aria-label="Cherry Clean Services LLC home"><img src="/assets/cherry-clean-logo.jpeg" alt="Cherry Clean Services LLC logo" /></a><nav class="desktop-nav">${nav.map(([label, path]) => `<a href="${path}" data-link>${label}</a>`).join('')}</nav><a class="header-cta" href="/contact-us/" data-link>Request a quote ${icon('arrow')}</a><button class="menu-toggle" aria-label="Open menu">${icon('menu')}</button><div class="mobile-menu"><button class="menu-close" aria-label="Close menu">${icon('close')}</button>${nav.map(([label, path]) => `<a href="${path}" data-link>${label}</a>`).join('')}<a class="mobile-quote" href="/contact-us/" data-link>Request a quote ${icon('arrow')}</a></div></header>`
}

function footer() {
  return `<footer class="site-footer"><div class="footer-top"><div><a class="brand footer-brand" href="/" data-link><img src="/assets/cherry-clean-logo.jpeg" alt="Cherry Clean Services LLC" /></a><p class="footer-statement">A cleaner kind of confidence.<br />For homes, businesses, and everything in between.</p></div><div class="footer-links"><span>Explore</span><a href="/services/" data-link>Services</a><a href="/about/" data-link>Our story</a><a href="/contact-us/" data-link>Contact</a></div><div class="footer-links"><span>Reach us</span><a href="tel:${PHONE_LINK}">${PHONE}</a><a href="mailto:${EMAIL}">${EMAIL}</a><span>Concord, CA 94521</span></div></div><div class="footer-bottom"><span>Cherry Clean Services LLC</span><span>Serving Concord & nearby Bay Area cities</span><span>© ${new Date().getFullYear()} All rights reserved</span></div></footer>`
}
